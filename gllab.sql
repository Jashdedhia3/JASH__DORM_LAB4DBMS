...
INSERT INTO CUSTOMER VALUES(4,"MEGHA",'9994562399',"KOLKATAI",'F');
...
INSERT INTO PRODUCT VALUES(4,"HARRY POTTER","Best Collection of all time by J.K Rowling",'1');
INSERT INTO PRODUCT VALUES(5,"OATS","Highly Nutritious from Nestle",'3');
INSERT INTO PRODUCT VALUES(6,"MILK","1L Toned MIlk",'3');
INSERT INTO PRODUCT VALUES(7,"Boat Earphones","1.5Meter long Dolby Atmos",'4');
INSERT INTO PRODUCT VALUES(8,"Jeans","Stretchable Denim Jeans with various sizes and colo",'5');
...
INSERT INTO ORDERR VALUES(112,780,"2021-09-16",4,7);
...
select product.pro_name, orderr.* from product inner join supplier_pricing on supplier_pricing.pro_id=product.pro_id
inner join orderr on orderr.pricing_id=supplier_pricing.pricing_id where orderr.cus_id=2;

select supplier.* from supplier inner join
(select supp_id from supplier_pricing group by supp_id having count(pro_id)>1) as t1
...
select product.pro_id,product.pro_name from orderr
inner join supplier_pricing
on supplier_pricing.pricing_id=orderr.pricing_id
